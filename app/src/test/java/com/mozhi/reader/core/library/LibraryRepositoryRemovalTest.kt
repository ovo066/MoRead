...
class LibraryRepositoryRemovalTest {
    ...
    @Before fun setup() {
        ...
        library = LibraryRepository(context, db, db.bookDao(), BookTextStore(context), BookTextWriter(),
            BookMediaStore(context), BookLayoutStore(context), Lazy { error("optional index unavailable") }, Lazy { io.mockk.mockk(relaxed = true) })
    }
    ...
    @Test fun realVersion28DatabasePreservesSavedOutlinesAndAddsCharacterTables() = runBlocking {
        ...
        val migrated = Room.databaseBuilder(context, MoReadDatabase::class.java, "knowledge-migration.db")
            .addMigrations(DatabaseMigrations.Migration28To29, DatabaseMigrations.Migration29To30, DatabaseMigrations.Migration30To31, DatabaseMigrations.Migration31To32).build()
        try {
    ...
    @Test fun realVersion25DatabaseMigratesWithoutRemovingExistingBooks() = runBlocking {
        ...
        val migrated = Room.databaseBuilder(context, MoReadDatabase::class.java, "migration.db")
            .addMigrations(DatabaseMigrations.Migration25To26, DatabaseMigrations.Migration26To27, DatabaseMigrations.Migration27To28, DatabaseMigrations.Migration28To29, DatabaseMigrations.Migration29To30, DatabaseMigrations.Migration30To31, DatabaseMigrations.Migration31To32).build()
        try {
